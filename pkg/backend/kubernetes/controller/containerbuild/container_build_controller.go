...
type Controller struct {
	...
	enqueue     func(build *latticev1.ContainerBuild)
	...
	componentBuildLister       latticelisters.ContainerBuildLister
...
func NewController(
	...
	componentBuildInformer := latticeInformerFactory.Lattice().V1().ContainerBuilds()
...
func (c *Controller) enqueueComponentBuild(build *latticev1.ContainerBuild) {
...
func (c *Controller) syncComponentBuild(key string) error {
	...
	build, err := c.componentBuildLister.ContainerBuilds(namespace).Get(name)
