					...
					Containers: []corev1.Container{
						{
							...
							Args: []string{
								...
								"--local-dns-controller-image", lp.getLatticeContainerImage(kubeconstants.DockerImageLocalDNSController),
								"--local-dns-server-image", kubeconstants.DockerImageLocalDNSServer,
