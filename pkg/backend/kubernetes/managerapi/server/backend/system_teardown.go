...
func (kb *KubernetesBackend) TearDownSystem(systemID types.SystemID) (types.TeardownID, error) {
...
func getSystemTeardownState(state latticev1.SystemTeardownState) types.TeardownState {
	switch state {
