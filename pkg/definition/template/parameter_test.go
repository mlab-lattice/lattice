...
func TestParameterBind(t *testing.T) {
	tests := []struct {
		...
		// secret parameter
		{
			...
			bindings: make(map[string]interface{}),
			path:     tree.NodePath("/foo/bar"),
			result:   map[string]interface{}{"foo": &definitionv1.SecretRef{Value: tree.NodePathSubcomponent("/foo/bar:baz")}},
			err:      nil,
		},
		{
		...
		},
		{
			...
			bindings: map[string]interface{}{"foo": &definitionv1.SecretRef{Value: tree.NodePathSubcomponent("/foo/bar:baz")}},
			path:     tree.NodePath("/foo/bar"),
			result:   map[string]interface{}{"foo": &definitionv1.SecretRef{Value: tree.NodePathSubcomponent("/foo/bar:baz")}},
			err:      nil,
		},
		{
			...
			bindings: map[string]interface{}{"foo": &definitionv1.SecretRef{Value: tree.NodePathSubcomponent("/foo/bar:qux")}},
			path:     tree.NodePath("/foo/bar"),
			result:   map[string]interface{}{"foo": &definitionv1.SecretRef{Value: tree.NodePathSubcomponent("/foo/bar:qux")}},
			err:      nil,
		},
		{
