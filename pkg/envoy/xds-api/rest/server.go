...
import (
	...
	"github.com/mlab-lattice/system/pkg/envoy/xds-api/cds"
	"github.com/mlab-lattice/system/pkg/envoy/xds-api/lds"
	"github.com/mlab-lattice/system/pkg/envoy/xds-api/rds"
	"github.com/mlab-lattice/system/pkg/envoy/xds-api/sds"
...
func RunNewRestServer(b envoy.Backend, port int32) {
	s := restServer{
		router: gin.Default(),
